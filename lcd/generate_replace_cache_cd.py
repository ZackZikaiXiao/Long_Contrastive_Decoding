        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            if calibration_enable:
                ...
                # 如果 topk_vector 比 attention_mask 更短，则在后面补0
                ...
                #     padding = torch.zeros(padding_length, device=topk_vector.device, dtype=topk_vector.dtype)
                #     topk_vector = torch.cat([topk_vector, padding])

                # 原地修改 attention_mask
                model_inputs["attention_mask"][0].fill_(0)
                # model_inputs["attention_mask"][0] *= (1 - topk_vector)

                # model_inputs["attention_mask"][0][200:290] = 0
                model_inputs["attention_mask"][0][0:50] = 1
                model_inputs["attention_mask"][0][seq_len-100:] = 1
                ...
                next_token_logits_noise = outputs_noise.logits[:, -1, :].clone()
                del outputs_noise
                ...
                # next_token_logits = next_token_logits_noise
            else:
